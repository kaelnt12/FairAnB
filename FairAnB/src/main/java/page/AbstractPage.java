...
public class AbstractPage {
	 ...
	 * @param driver
	 */
	public void clickDashboardButton(WebDriver driver) {
		waitForElement(driver, interfaces.AbstractPage.DASHBOARD_BUTTON, Constant.TimeWait);
		click(driver, interfaces.AbstractPage.DASHBOARD_BUTTON);
	}
	 ...
	 */
	public void logOut() {
		waitForElement(driver, interfaces.AbstractPage.LOGOUT_BUTTON, Constant.TimeWait);
		click(driver, interfaces.AbstractPage.LOGOUT_BUTTON);
	}

	/**
	 * @author Bao Dao Q. Check Dynamic Header Displayed
	 */
	public boolean isDynamicPageHeaderDisplayed(WebDriver driver, String value) {
	...
	/**
	 * Check Menu Bar displayed
	 * 
	 * @return
	 */
	public boolean isNenuBarDisplayed() {
		waitForElement(driver, interfaces.AbstractPage.MENU_BAR, Constant.TimeWait);
		return isControlDisplayed(driver, interfaces.AbstractPage.MENU_BAR);
	}
	...
	public void clickStatisticsLinK() {
		waitForElement(driver, interfaces.AbstractPage.STATISTICS_DASHBOARD_LINK, Constant.TimeWait);
		click(driver, interfaces.AbstractPage.STATISTICS_DASHBOARD_LINK);
	}
	...
	public void clickRankingLink() {
		waitForElement(driver, interfaces.AbstractPage.RANKING_LINK, Constant.TimeWait);
		click(driver, interfaces.AbstractPage.RANKING_LINK);
		sleep(2);
	}

	/**
	 * Click Counseling Link
	 */
	public void clickCounselingLink() {
		waitForElement(driver, interfaces.AbstractPage.COUNSELING_LINK, Constant.TimeWait);
		click(driver, interfaces.AbstractPage.COUNSELING_LINK);
		sleep(2);
	}
	...
	public void clickEmployeeLink() {
		waitForElement(driver, interfaces.AbstractPage.EMPLOYEE_LINK, Constant.TimeWait);
		click(driver, interfaces.AbstractPage.EMPLOYEE_LINK);
		sleep(2);
	}
	...
	public void clickMessageLink() {
		waitForElement(driver, interfaces.AbstractPage.MESSAGE_LINK, Constant.TimeWait);
		click(driver, interfaces.AbstractPage.MESSAGE_LINK);
		sleep(2);
	}

	public ArrayList<String> getAllValueOfDropdown(String controlName) {
		// waitForElement(driver, controlName, Constant.TimeWait);
		// return (List<WebElement>) control.findElements(driver, controlName);
		Select select = (Select) control.findElement(driver, controlName);
		List<WebElement> elements = (List<WebElement>) select.getAllSelectedOptions();
